...
export const createPinNew = async (
    ...
    try {
        const response = await pool.query(
            `INSERT INTO public.pins (name, text_description, dateBegin, label, longitude, latitude, imageUrl, user_id)
             VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
             RETURNING *`,
            [name, text_description, dateBegin, label, longitude, latitude, imageUrl, user_id]
        );
